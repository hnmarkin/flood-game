...
[Category("WaterUnit")]
public sealed class WaterPhysicsTests : WaterEditModeFixture
{
    ...
    {
        // Arrange
        WaterRuntimeFixture fixture = CreateRuntime(2, 1, elevations: new[] { 2, 5 });
    ...
    public void InitialSources_AllRegions_ApplyAbsoluteDepthToIntendedCells()
    {
        ...
        WaterRuntimeFixture fullMap = CreateRuntime(3, 3, waterBodies: waterBodies);
        WaterRuntimeFixture edges = CreateRuntime(3, 3, waterBodies: waterBodies);
        WaterRuntimeFixture corners = CreateRuntime(3, 3, waterBodies: waterBodies);
    ...
    public void ContinuousSource_ModifierScalingAndDeltaTime_AppliesResolvedDepthUnits()
    {
        ...
        WaterModifierSnapshot modifiers = Defaults();
        modifiers.RainfallRate = 2f;
        modifiers.ExternalWaterLoad = 3f;
        modifiers.AntecedentWetness = 0.5f;

        // Act
        WaterStepSummary summary = fixture.Physics.Step(new[] { source }, modifiers, 0.25f);
    ...
    public void Physics_InternalFlowWithoutSourcesOrDrainage_ConservesWater()
    {
        ...
        WaterRuntimeFixture fixture = CreateRuntime(3, 1, new[] { 3f, 0f, 0f }, settings: settings);
    ...
    public void Physics_DrainageEfficiency_RemovesTimeScaledDepthWithoutGoingNegative()
    {
        ...
        WaterRuntimeFixture fixture = CreateRuntime(2, 1, new[] { 2f, 0.5f }, settings: settings);
        WaterModifierSnapshot modifiers = Defaults();
        modifiers.DrainageEfficiency = 1.5f;

        // Act
        WaterStepSummary summary = fixture.Physics.Step(null, modifiers, 0.5f);
    ...
    public void Physics_SpreadGateInactiveNeighbor_PreventsFlowUntilIntervalExpansion()
    {
        ...
        WaterRuntimeFixture fixture = CreateRuntime(2, 1, new[] { 1f, 0f }, settings: settings);
    ...
    public void Physics_BarrierBelowSurface_OvertopsInBothAxes(bool yAxis)
    {
        ...
        WaterRuntimeFixture fixture = yAxis
    ...
    public void Physics_BoundarySource_AddsConfiguredDepthPerSecondOnlyToSelectedEdge()
    {
        ...
        WaterRuntimeFixture fixture = CreateRuntime(3, 2, settings: settings);
    ...
    public void Physics_BoundarySink_RemovesAllWaterFromSelectedEdge()
    {
        // Arrange
        WaterSimulationSettings settings = CreateSettings();
        settings.northBoundary.mode = WaterBoundaryMode.Sink;
        WaterRuntimeFixture fixture = CreateRuntime(3, 2, new[] { 1f, 1f, 1f, 1f, 1f, 1f }, settings: settings);
    ...
    {
        // Arrange
        WaterRuntimeFixture fixture = CreateRuntime(2, 1, new[] { 1f, 0f });

        // Act
        WaterStepSummary summary = fixture.Physics.Step(null, Defaults(), 0.25f);
    ...
    private static WaterModifierSnapshot Defaults()
    {
        return WaterModifierSnapshot.Defaults();
    }

    private static float SumWater(WaterState state)
    {
        float total = 0f;
