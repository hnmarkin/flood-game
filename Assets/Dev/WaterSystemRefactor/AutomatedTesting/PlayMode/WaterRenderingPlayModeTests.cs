...
public sealed class WaterRenderingPlayModeTests : WaterPlayModeFixture
{
    ...
    {
        // Arrange
        WaterRenderingFixture fixture = CreateRenderingFixture(0.5f);
    ...
    {
        // Arrange
        WaterRenderingFixture fixture = CreateRenderingFixture(0f);
        fixture.Renderer.Initialize(fixture.State, fixture.Accessor);
    ...
    {
        // Arrange
        WaterRenderingFixture fixture = CreateRenderingFixture(0.5f, includeNullTilemap: true);
    ...
    {
        // Arrange
        WaterRenderingFixture fixture = CreateRenderingFixture(0.5f, rendererDefinitionAssigned: false);
